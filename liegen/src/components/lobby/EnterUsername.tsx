...
import { setUserData, setGameData } from '../../slices/gameStateSlice';
...
const continueGame = (data: {userData: {}, gameData: {}}, setUserDataDispatch: setUserDataDispatch, setGameDataDispatch: setGameDataDispatch) => {
  setUserDataDispatch(data.userData);
  setGameDataDispatch(data.gameData);
}
